...
public interface IReviewRepository : IGenericRepository<Review>
{
    ...
    public Task<IEnumerable<Review>> FindReviewsWithUserAsync(CancellationToken cancellationToken = default);
    public Task<Review?> FindReviewByIdByWithUserAsync(int id, CancellationToken cancellationToken = default);
